...
public class UserRequest {
    ...
    @NotBlank(groups = {UserRequestValidator.Login.class, UserRequestValidator.Register.class})
    @Email(groups = {UserRequestValidator.Login.class, UserRequestValidator.Register.class})
     ...
     */
    @NotBlank(groups = {UserRequestValidator.Login.class, UserRequestValidator.Register.class})
    @Pattern(regexp = "^(?=.*[A-Za-z])(?=.*[0-9]).{8,}$", groups = {UserRequestValidator.Register.class})
